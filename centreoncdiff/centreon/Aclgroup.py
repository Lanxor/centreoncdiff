...
class Aclgroup:
    ...
    def construct(cls, data: dict) -> 'Aclgroup':
        ...
        if 'contact' in data:
            centreonObject.setContact(data['contact'])
        if 'contactGroup' in data:
            centreonObject.setContactGroup(data['contactGroup'])
        if 'menu' in data:
            centreonObject.setMenu(data['menu'])
        if 'action' in data:
            centreonObject.setAction(data['action'])
        if 'resource' in data:
            centreonObject.setResource(data['resource'])
